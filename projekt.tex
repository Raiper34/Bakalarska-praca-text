...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={webova platforma, tvorba, HTML5 hra, Nette, Bootstrap, Phaser}, %klicova slova v ceskem jazyce
  keywords.en={web platform, making, HTML5 game, Nette, Bootstrap, Phaser}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={Výtah (abstrakt) práce v českém jazyce. TODO}, % abstrakt v ceskem jazyce
  abstract.en={Výtah (abstrakt) práce v anglickém jazyce. TODO}, % abstrakt v anglickem jazyce
  %Prohlaseni
  ...
  acknowledgment={Zde je možné uvést poděkování vedoucímu práce a těm, kteří poskytli odbornou pomoc. TODO} % nepovinne
}
