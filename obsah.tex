...
\end{enumerate}
Ak hlavičky vrátené serverom, neexistujú, alebo nie sú očakávané odpoveď je zamietnutá a klient si nemôže túto odpoveď pozrieť. Na servery môže byť špecifikované, ktoré domény môžu robiť požiadavky a ktoré metódy a ktoré hlavičky sú povolené v HTTP požiadavku. 
\begin{figure}[h]
  \centering
